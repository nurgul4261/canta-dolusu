...
const run = async () => {
  ...
  const categories = await Category.insertMany([
    {
      name: "Kol Çantası",
      slug: "kol-cantasi",
      description: "Şık ve kullanışlı kol çantaları",
      order: 1,
    },
    {
      name: "Çapraz Çanta",
      slug: "capraz-canta",
      description: "Her kombine uyan çapraz çantalar",
      order: 2,
    },
    {
      name: "Sırt Çantası",
      slug: "sirt-cantasi",
      description: "Günlük ve şık sırt çantaları",
      order: 3,
    },
  ]);
  ...
  const products = [
    // ── KOL ÇANTALARI ──────────────────────────────────────
    {
      ...
      description:
        "Tam tahıl dana derisi kullanılarak üretilmiş, günlük kullanım için ideal kol çantası. Fermuarlı ana bölme, içinde telefon ve kart cebi mevcuttur. Metal tokalı çıkarılabilir omuz askısıyla kol ya da omuzdan taşıma imkânı sunar.",
      price: 1890,
      discountPrice: 1490,
    ...
    },
    {
      ...
      description:
        "Pürüzsüz rugan yüzeyiyle dikkat çeken bu minimalist kol çantası, akşam davetlerinden günlük kullanıma uzanan geniş bir yelpazede stilinizi tamamlar. Manyetik kapaklı tasarımı ve altın rengi metal detaylarıyla zarif bir görünüm sunar.",
      price: 990,
      discountPrice: null,
      category: kolCanta._id,
      brand: "Çanta Dolusu",
    ...
    },
    {
      ...
      description:
        "El örgüsü hasır dokusundan üretilen bu çanta, yaz aylarının ve plaj kombinlerinin vazgeçilmezi. Deri saplı ve fermuarlı, içinde süet astarlı geniş bir bölme bulunmaktadır. Doğal ve çevre dostu malzeme kullanılmıştır.",
      price: 750,
      discountPrice: 599,
      category: kolCanta._id,
      brand: "Çanta Dolusu",
    ...
    // ── ÇAPRAZ ÇANTALAR ────────────────────────────────────
    {
      ...
      description:
        "Şehir hayatının hızına ayak uyduran bu kompakt çapraz çanta, telefon, kart ve anahtarlarınızı kolayca taşımanızı sağlar. Ayarlanabilir zincir askısı ve çift fermuar bölmesiyle hem şık hem güvenlidir.",
      price: 650,
      discountPrice: 520,
    ...
    },
    {
      ...
      description:
        "Vintage ilhamıyla tasarlanan bu postacı çantası, deri görünümlü kumaş yapısıyla hem hafif hem de dayanıklıdır. Tablet veya küçük notebook sığabilecek büyüklükteki ana bölmesi ve ön organizatör cebiyle iş ve günlük kullanım için idealdir.",
      price: 1150,
      discountPrice: null,
      category: caprazCanta._id,
      brand: "Çanta Dolusu",
    ...
    },
    {
      ...
      description:
        "Kapitone dikiş detaylarıyla lüks bir görünüm sunan bu çapraz çanta, altın zincir askısıyla her kombini tamamlar. Akşam yemeklerinden hafta sonu gezilerine kadar her ortama uyum sağlar.",
      price: 1350,
      discountPrice: 1099,
      category: caprazCanta._id,
      brand: "Çanta Dolusu",
    ...
    // ── SIRT ÇANTALARI ─────────────────────────────────────
    {
      ...
      description:
        'Su geçirmez nylon kumaşı ve ergonomik sırt desteğiyle uzun günlere hazır bir sırt çantası. 15.6" laptop bölmesi, USB şarj çıkışı ve çoklu organizatör cebiyle hem öğrenci hem profesyoneller için ideal.',
      price: 1299,
      discountPrice: 999,
    ...
    },
    {
      ...
      description:
        "Gerçek deri yapısıyla hem zarif hem dayanıklı bu mini sırt çantası, hafta sonu gezileri ve günlük kullanım için mükemmel. Küçük boyutuna karşın üç bölmesiyle şaşırtıcı bir organizasyon kapasitesi sunar.",
      price: 2200,
      discountPrice: null,
      category: sirtCanta._id,
      brand: "Çanta Dolusu",
    ...
    },
    {
      ...
      description:
        "İşlemeli nakış detayları ve püskül süslemeleriyle benzersiz bir görünüm sunan bu bohem sırt çantası, özgün tarzını yansıtmak isteyenler için tasarlandı. Vegan deri ve dokuma kumaşın mükemmel uyumuyla üretilmiştir.",
      price: 870,
      discountPrice: 699,
      category: sirtCanta._id,
      brand: "Çanta Dolusu",
