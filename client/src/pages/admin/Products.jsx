    ...
    <div>
      ...
      {showForm && (
        <div className="admin-card" style={{ marginBottom: 28 }}>
          <h3 style={{ fontSize: 16, color: "var(--brown)", marginBottom: 20 }}>
          ...
          >
            ...
            <div className="form-group" style={{ gridColumn: "1/-1" }}>
              <label>Görseller (her satıra bir URL)</label>
              <textarea
                className="form-control"
                rows={3}
                value={form.images}
            ...
            <tbody>
              {products.map((p) => (
                <tr key={p._id}>
                  ...
                  <td>
                    <strong>
                      ₺{(p.discountPrice || p.price).toLocaleString("tr-TR")}
                    </strong>
                    {p.discountPrice && (
                      <span
                        style={{
                  ...
                  <td
                    style={{
                      color: p.stock < 5 ? "var(--error)" : "var(--text)",
                    }}
                  >
                    {p.stock}
                  </td>
                  <td>
                    <span
                      style={{
                        ...
                        padding: "2px 8px",
                        borderRadius: 99,
                        background: p.isActive ? "#d4edda" : "#fde8e8",
