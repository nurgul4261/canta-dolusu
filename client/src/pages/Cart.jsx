...
const Cart = () => {
  ...
  const shippingPrice = subtotal >= 500 ? 0 : 49.9;
  ...
  const handleCoupon = async () => {
    ...
    try {
      ...
      setCouponData(data);
      toast.success(
        `Kupon uygulandı! ₺${data.discountAmount} indirim kazandınız 🎉`,
      );
    } catch (err) {
        ...
        <div className="cart-layout">
          ...
          <div className="cart-items">
            {items.map((item, i) => (
              <div key={i} className="cart-item">
                ...
                <div className="cart-item-info">
                  <Link to={`/urunler/${item.slug}`} className="cart-item-name">
                    {item.name}
                  </Link>
                  {item.selectedColor && (
            ...
            <div className="cart-actions">
              ...
              <Link to="/urunler" className="btn btn-outline btn-sm">
                <FiShoppingBag /> Alışverişe Devam
              </Link>
            </div>
          </div>
          ...
          <div className="cart-summary">
            ...
            {discountAmount > 0 && (
              <div className="summary-row discount">
                <span>İndirim ({couponData.code})</span>
            ...
            {subtotal < 500 && (
              <p className="free-shipping-hint">
                ₺{(500 - subtotal).toFixed(0)} daha alışveriş yaparak ücretsiz
                kargo kazan!
              </p>
            )}
