            ...
            {user?.addresses?.length > 0 && (
              <div className="checkout-section">
                ...
                <div className="addr-tabs">
                  <button
                    type="button"
                    className={`addr-tab${useExisting ? " active" : ""}`}
                ...
                {useExisting ? (
                  <div className="saved-addresses">
                    {user.addresses.map((addr) => (
                      <label
                        key={addr._id}
                        className={`saved-addr${selectedAddr === addr._id ? " selected" : ""}`}
                      >
                        <input
                          type="radio"
                          name="addr"
            ...
            <div className="checkout-section">
              ...
              {paymentMethod === "bank_transfer" && (
                <div className="bank-info">
                  <p>
                    <strong>Hesap Adı:</strong> Çanta Dolusu Tic. Ltd. Şti.
                  </p>
                  <p>
                  ...
                  >
                    Sipariş numaranızı açıklama kısmına yazınız.
                  </p>
                </div>
              )}
            </div>
